...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-violet-500 via-purple-400 to-orange-200 flex items-center justify-center p-6">
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          <a href="/" className="inline-flex items-center gap-2.5 mb-6">
            ...
            <span className="text-2xl font-bold tracking-tight text-gray-900">distributo</span>
          </a>
